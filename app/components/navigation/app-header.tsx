      ...
      <div className="flex h-24 items-center px-6">
        ...
        <div className="flex items-center gap-3">
          <div className="hidden md:flex flex-col text-right">
            ...
            <span className="text-xs text-blue-400">{currentUser.role}</span>
          </div>
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-64 border-blue-100" align="end" forceMount>
              <div className="flex items-center justify-start gap-3 p-3 border-b border-blue-100">
                ...
                <div className="flex flex-col space-y-1">
                  <p className="font-semibold text-sm text-blue-900">{currentUser.name}</p>
                  <p className="text-xs text-blue-400">{currentUser.email}</p>
                  {currentUser.crea && <p className="text-xs text-blue-400">CREA: {currentUser.crea}</p>}
                </div>
              </div>
              <div className="p-1">
