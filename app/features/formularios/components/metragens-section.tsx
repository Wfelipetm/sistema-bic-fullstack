  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className="text-center">
        <Label htmlFor="areaTerreno" className="text-sm font-medium block mb-2">
          Área do Terreno:
        </Label>
      ...
      <div className="text-center">
        <Label htmlFor="testada" className="text-sm font-medium block mb-2">
          Testada:
        </Label>
        <div className="relative">
          <Input
      ...
      <div className="text-center">
        <Label htmlFor="areaEdificada" className="text-sm font-medium block mb-2">
          Área Edificada:
        </Label>
        <div className="relative">
          <Input
