...
const conservacaoEdificacaoRoute = require('./src/routes/conservacaoEdificacaoRoute');
const tipoFachadaRoute = require('./src/routes/tipoFachadaRoute');
const tipoForroRoute = require('./src/routes/tipoForroRoute');
const instalacaoEletricaRoute = require('./src/routes/instalacaoEletricaRoute');
const instalacaoSanitariaRoute = require('./src/routes/instalacaoSanitariaRoute');
const situacaoEdificacaoRoute = require('./src/routes/situacaoEdificacaoRoute');
const pavimentacaUnidadeRoute = require('./src/routes/pavimentacaUnidadeRoute');
const posicaoUnidadeRoute = require('./src/routes/posicaoUnidadeRoute');
const situacaoUnidadeRoute = require('./src/routes/situacaoUnidadeRoute');
const ocupacaoTerrenoRoute = require('./src/routes/ocupacaoTerrenoRoute');
const limitacaoTerrenoRoute = require('./src/routes/limitacaoTerrenoRoute');
const proporcaoTerrenoRoute = require('./src/routes/proporcaoTerrenoRoute');
const pedologiaTerrenoRoute = require('./src/routes/pedologiaTerrenoRoute');
...
app.use('/conservacao-edificacao', jwt.validarToken, conservacaoEdificacaoRoute);
app.use('/tipo-fachada', jwt.validarToken, tipoFachadaRoute);
app.use('/tipo-forro', jwt.validarToken, tipoForroRoute);
app.use('/instalacao-eletrica', jwt.validarToken, instalacaoEletricaRoute);
app.use('/instalacao-sanitaria', jwt.validarToken, instalacaoSanitariaRoute);
app.use('/situacao-edificacao', jwt.validarToken, situacaoEdificacaoRoute);
app.use('/pavimentacao-unidade', jwt.validarToken, pavimentacaUnidadeRoute);
app.use('/posicao-unidade', jwt.validarToken, posicaoUnidadeRoute);
app.use('/situacao-unidade', jwt.validarToken, situacaoUnidadeRoute);
app.use('/ocupacao-terreno', jwt.validarToken, ocupacaoTerrenoRoute);
app.use('/limitacao-terreno', jwt.validarToken, limitacaoTerrenoRoute);
app.use('/proporcao-terreno', jwt.validarToken, proporcaoTerrenoRoute);
app.use('/pedologia-terreno', jwt.validarToken, pedologiaTerrenoRoute);
